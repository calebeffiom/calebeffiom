...
<p><em>Software Enginner at <a href="http://t3kit.xyz">T3Kit</a><img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="50"> 
</em></p>
...
const caleb = {
  pronouns: "he" | "him",
  Frontend: [Javascript, Typescript, HTML, CSS, Tailwind, ReactJs, NextJs],
  Backend: [ Node, MongoDB, Firebase, Express],
  Cloud: ["AWS, Google Cloud, Vercel, Cloudinary"],

 Goal: "Become the ultimate Javascript final boss"
}
```

<img src="https://media.giphy.com/media/LnQjpWaON8nhr21vNW/giphy.gif" width="60"> <em><b>I'm open to making new friends and working on projects</b> so if you want to say <b>hi, I'll be happy to meet you more!</b> :) ❤️</em>

---

⭐️ From [@King Caleb III](https://github.com/calebeffiom)
